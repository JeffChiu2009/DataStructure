...
def find_all_indexes(text, pattern):
    ...
    while(shift <= text_len - pattern_len):
        ...
        if index < 0:
            ...
            lastletter = text[shift+pattern_len-1]
            if lastletter in pattern:
                shift += pattern_len - pattern.index(lastletter) - 1
